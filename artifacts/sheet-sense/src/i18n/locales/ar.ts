...
const ar: Translations = {
  ...
  dashboard: {
    ...
    renameInputPlaceholder: "اسم المشروع",
    renameError: "تعذّر إعادة تسمية المشروع. يرجى المحاولة مرة أخرى.",
    ...
    projectNamePlaceholder: "مثلاً: تحليل مبيعات الربع الأول",
    creating: "جارٍ الإنشاء…",
    createError: "تعذّر إنشاء المشروع. يرجى المحاولة مرة أخرى.",
  },
  workspace: {
    addFileTo: 'أضف ملفاً إلى "{name}"',
    backToDashboard: "لوحة التحكم",
    loadingProject: "جارٍ فتح المشروع…",
    loadingProjectSub: "يتم تنزيل الملفات وإعادة بناء مساحة العمل",
    projectNotFound: "المشروع غير موجود",
    projectNotFoundSub: "قد يكون هذا المشروع قد حُذف أو لا تملك صلاحية الوصول إليه.",
    openingError: "فشل فتح المشروع",
    uploadFirstFile: "ارفع ملفك الأول للبدء",
    filesUnavailable: "{n} ملف/ملفات لم يمكن إعادة تحميلها من التخزين وتحتاج إلى رفع مجدد.",
  ...
  relationships: {
    ...
    savingError: "تعذّر حفظ العلاقة. يرجى المحاولة مرة أخرى.",
    deletingError: "تعذّر حذف العلاقة. يرجى المحاولة مرة أخرى.",
    diagram: {
      title: "مخطط العلاقات",
